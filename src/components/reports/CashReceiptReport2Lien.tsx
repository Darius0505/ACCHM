...
import type { CashReceiptReportData } from './CashReceiptReport';
...
export const CashReceiptReport2Lien: React.FC<{
    ...
    return (
        <Document title={`${VOUCHER_CONFIGS.CASH_RECEIPT.title}_${data.receiptNumber}`} author={company.name}>
...
export default CashReceiptReport2Lien;

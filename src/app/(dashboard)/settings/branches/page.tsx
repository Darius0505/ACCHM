...
export default function BranchesPage() {
    ...
    const handleDelete = async (item: Branch) => {
        if (!confirm(`Bạn có chắc muốn xóa chi nhánh "${item.name}"?`)) return;
            ...
            <div style={{
                ...
                <div>
                    ...
                    <p style={{ fontSize: '13px', color: 'var(--text-secondary, #94a3b8)', margin: 0 }}>
                        Thiết lập danh sách chi nhánh và văn phòng làm việc
                    </p>
                </div>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: '900px' }}>
                            <thead>
                                <tr style={{ background: 'var(--grid-header-bg, #334155)' }}>
                                    ...
                                    <th style={{ ...thStyle, textAlign: 'left', minWidth: '100px' }}>Mã CN</th>
                                    <th style={{ ...thStyle, textAlign: 'left', minWidth: '200px' }}>Tên Chi nhánh</th>
                                    <th style={{ ...thStyle, textAlign: 'left', minWidth: '250px' }}>Địa chỉ</th>
                                    <th style={{ ...thStyle, textAlign: 'left', minWidth: '120px' }}>Điện thoại</th>
                                    <th style={{ ...thStyle, textAlign: 'center', width: '100px' }}>Phòng ban</th>
                                ...
                                {data.length === 0 ? (
                                    <tr>
                                        <td colSpan={8} style={{
                                            ...
                                            Chưa có chi nhánh nào. Hãy thêm mới!
                                        </td>
                                    </tr>
                                ) : data.map((item, idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td style={{ ...tdStyle, color: 'var(--text-secondary, #94a3b8)' }}>{item.address || '—'}</td>
                                            <td style={{ ...tdStyle, color: 'var(--text-secondary, #94a3b8)' }}>{item.phone || '—'}</td>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <h2 style={{
                            ...
                            {editingItem ? '✏️ Sửa chi nhánh' : '➕ Thêm chi nhánh mới'}
                        </h2>
